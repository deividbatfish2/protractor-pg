...
var ProjetoService = /** @class */ (function () {
    ...
    ProjetoService.prototype.criarProjetoSeNaoExiste = function (projeto) {
        return __awaiter(this, void 0, void 0, function () {
            var existe, projetoCriado, projetoExistente;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.projetoRepository.save(projeto)];
                    case 3:
                        projetoCriado = _a.sent();
                        return [2 /*return*/, projetoCriado];
    ...
    ProjetoService.prototype.projetoExiste = function (projeto) {
        return __awaiter(this, void 0, void 0, function () {
            var existe;
            return __generator(this, function (_a) {
                switch (_a.label) {
